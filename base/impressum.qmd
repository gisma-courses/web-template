...
[{{uni_name}}]({{uni_url}}).
It is developed at the [{{institute_name}}]({{institute_url}}) under responsibility of the [{{chair_name}}]({{chair_url}}).

<p>{{responsible_name}}<br />{{responsible_address}}</p>
<p>Email: <a href="mailto:{{responsible_email}}">{{responsible_email}}</a></p>
<p>Imprint: <a href="{{imprint_url}}" target="_blank">{{imprint_url}}</a>.</p>
...
[{{uni_name}}]({{uni_url}}). It is developed at the
[{{institute_name}}]({{institute_url}}) under responsibility of the
[{{chair_name}}]({{chair_url}}).
...
<p>{{responsible_name}}<br />{{responsible_address}}</p>
<p>Email address: <a href="mailto:{{responsible_email}}">{{responsible_email}}</a>.</p>
<p>Imprint: <a href="{{imprint_url}}" target="_blank">{{imprint_url}}</a>.</p>
